...
public class PlaceOrderTopsController {
    ...
    @FXML
    void btnRoyalEthnicTops(ActionEvent e) {
        selectItem("Royal Ethnic Tops", 7500);
        buyNow("Royal Ethnic Tops", 7500.00);
    }

    @FXML
    void btnElegantKurti(ActionEvent e) {
        selectItem("Elegant Kurti", 6000.00);
        buyNow("Elegant Kurti", 6000.00);
    }

    @FXML
    void btnModernFusionKurtis(ActionEvent e) {
        selectItem("Modern Fusion Kurtis", 8200.00);
        buyNow("Modern Fusion Kurtis", 8200.00);
    }

    @FXML
    void btnSignatureDesignerTops(ActionEvent e) {
        selectItem("Signature Designer Tops", 9500.00);
        buyNow("Signature Designer Tops", 9500.00);
    }

    @FXML
    void btnTrendyEthnicWear(ActionEvent e) {
        selectItem("Trendy Ethnic Wear", 7000.00);
        buyNow("Trendy Ethnic Wear", 7000.00);
    }

    @FXML
    void btnDivaKurtiEdition(ActionEvent e) {
        selectItem("Diva Kurti Edition", 6500.00);
